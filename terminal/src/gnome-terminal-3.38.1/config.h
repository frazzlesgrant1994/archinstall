...
#define ENABLE_SEARCH_PROVIDER 1
...
#define GDK_VERSION_MIN_REQUIRED G_ENCODE_VERSION(3,18)
...
#define GLIB_VERSION_MIN_REQUIRED G_ENCODE_VERSION(2,52)
...
#define PACKAGE_STRING "GNOME Terminal 3.38.1"
